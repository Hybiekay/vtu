<div class="page-content header-clear-medium">
        ...
        <div class="card card-style">
            <div class="content">
                ...
                <h1 class="font-20">Data Pin Plan</h1>
                <p class="text-danger">Scroll Horizontally To View Entire Table</p>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        <tr class="bg-blue-dark">
                        ...
                        <?php if(!empty($data8)): foreach ($data8 AS $plans): ?>
                            <tr>
                                <td><?php echo $plans->network; ?></td>
                                <td><?php echo $plans->dpId; ?></td>
                                <td><?php echo "$plans->name ($plans->type) ($plans->day days)"; ?></td>
                                <td>N<?php echo $plans->userprice; ?></td>
                                <td>N<?php echo $plans->agentprice; ?></td>
                                <td>N<?php echo $plans->vendorprice; ?></td>
                ...
                <h1 class="font-20">Recharge Card Plans</h1>
                <p class="text-danger">Scroll Horizontally To View Entire Table</p>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        <tr class="bg-blue-dark">
                        ...
                        <?php if(!empty($data9)): foreach ($data9 AS $plans): ?>
                            <tr>
                                <td><?php echo $plans->network; ?> <?php echo $plans->planSize; ?></td>
                                <td><?php echo $plans->aId; ?></td>
                                <td>N<?php echo $plans->aUserPrice; ?></td>
                                <td>N<?php echo $plans->aAgentPrice; ?></td>
                                <td>N<?php echo $plans->aVendorPrice; ?></td>
                            </tr>
                        <?php endforeach; endif; ?>
                    </table>
                </div>
