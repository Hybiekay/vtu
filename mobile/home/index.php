...
<?php if($title <> "Print Data Pin" && $title <> "Print Airtime Pin"): ?>
            ...
            <div class="row mb-0">
                <div class="col-12">
                    <div class="input-style input-style-always-active has-borders mb-4">
                        ...
                        <input type="number" id="thetranspin" maxlength="5" class="form-control" placeholder="12345" required>
                    </div>
                </div>
            </div>
    ...
    <div id="agent-upgrade-modal" 
        ...
        <div class="content">
            ...
            <div class="row mb-0">
                ...
                <div class="col-12">
                    <div class="input-style input-style-always-active has-borders mb-4">
                        <input type="password" name="kpin" maxlength="5" class="form-control" placeholder="12345" required>
                        <label for="form1" class="color-highlight">Transaction Pin</label>
                    </div>
                </div>
                <?php else: ?>
