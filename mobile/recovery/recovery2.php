    ...
    <div class="sila" style="min-width:350px">
            <div class="content">
                ...
                <div class="px-2">
                    ...
                    <button type="submit" id="submit-btn" style="width: 100%;" class="fancy-button font-600 font-15 rounded-s">
                        Recover Password
                    </button>
...
<br/><br/><br/> <div align="center"> <h5>- <a class="text-silver" href="../login/">Login Account</a> -</h5></div><br/><br/>
                        <a href="../register/">
  <button style="width: 100%;" class="fancy-button2 font-600 font-15 rounded-s">
                        Create Account
                    </button></a>
