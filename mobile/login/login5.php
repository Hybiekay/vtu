            ...
            <div class="bottom">
                ...
                <form method="POST" id="login-form">
                    <div class="form-group" id="phonediv">
                        ...
                        <input type="number" class="form-control" id="phonelogin" name="phone" placeholder="Phone" readonly required />
                    </div> 
                    <div class="form-group">
                     
                        <label for="">Password</label> 
                        <input type="password" class="form-control" id="passwordlogin" name="password" placeholder="Password" readonly required />
                    </div> 
                    <div class="form-group">
