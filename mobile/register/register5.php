            ...
            <div class="bottom">
                ...
                <form id="reg-form" method="post">
                    <div id="regDiv">
                        ...
                        <div class="form-group" >
                        <a id="next-btn" style="width: 100%;" class="btn btn-full btn-l font-600 font-15 btn-primary mt-4 rounded-s">
                            Continue
                        </a>
                        </div>
                    </div>
                    ...
                    <div id="nextregDiv" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="transpin" id="transpin"  class="form-control"  placeholder="Transaction Pin" required>
                        </div>  
                        <div class="form-group">
