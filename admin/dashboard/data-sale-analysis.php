    ...
    <div class="col-12">
        <div class="box">
            <div class="box-header with-border d-flex align-items-center justify-content-between">
              <h4 class="box-title"><b>Data Sales Analysis</b></h4>
					...
					<tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <h4 class="text-dark"><b>MTN Data<br/> Sales</b></h4> 
                                <h2 class="text-primary">N<?php echo $data["mtnSales"]; ?></h2>
                                <h3 class="text-dark"><b>(<?php echo $data["mtnSalesSize"]; ?> GB)</b></h3> 
                            ...
                            <td>
                                <img src="../../assets/images/icons/mtn.png" class="sale-icon" />
                                <h4 class="text-dark"><b>MTN Data<br/> Profit</b></h4> 
                        ...
                        <tr>
                            <td>
                                ...
                                <h4 class="text-dark"><b>Airtel Data<br/> Sales</b></h4> 
                                <h2 class="text-primary">N<?php echo $data["airtelSales"]; ?></h2>
                                <h3 class="text-dark"><b>(<?php echo $data["airtelSalesSize"]; ?> GB)</b></h3> 
                                <h4 class="text-dark"><b>(<?php echo $data["airtelTransactions"]; ?> Transactions)</b></h4> 
                            </td>

                            <td>
                                <img src="../../assets/images/icons/airtel.png" class="sale-icon" />
                                <h4 class="text-dark"><b>Airtel Data<br/> Profit</b></h4> 
                        ...
                        <tr>
                            <td>
                                ...
                                <h4 class="text-dark"><b>Glo Data<br/> Sales</b></h4> 
                                <h2 class="text-primary">N<?php echo $data["gloSales"]; ?></h2>
                                <h3 class="text-dark"><b>(<?php echo $data["gloSalesSize"]; ?> GB)</b></h3> 
                                <h4 class="text-dark"><b>(<?php echo $data["gloTransactions"]; ?> Transactions)</b></h4> 
                            </td>

                            <td>
                                <img src="../../assets/images/icons/glo.png" class="sale-icon" />
                                <h4 class="text-dark"><b>Glo Data<br/> Profit</b></h4> 
                        ...
                        <tr>
                            <td>
                                ...
                                <h4 class="text-dark"><b>9mobile Data<br/> Sales</b></h4> 
                                <h2 class="text-primary">N<?php echo $data["9mobileSales"]; ?></h2>
                                <h3 class="text-dark"><b>(<?php echo $data["9mobileSalesSize"]; ?> GB)</b></h3> 
                                <h4 class="text-dark"><b>(<?php echo $data["9mobileTransactions"]; ?> Transactions)</b></h4> 
                            </td>

                            <td>
                                <img src="../../assets/images/icons/9mobile.png" class="sale-icon" />
                                <h4 class="text-dark"><b>9mobile Data<br/> Profit</b></h4> 
