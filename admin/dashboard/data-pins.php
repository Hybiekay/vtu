    ...
    <div class="col-12">
        <div class="box">
            <div class="box-header with-border d-flex align-items-center justify-content-between">
              <h4 class="box-title">All Data Pins</h4>
              <div>
                  <a class="btn btn-primary btn-rounded text-white" href="data-pin-stock">
                    <i class="fa fa-shopping-cart" aria-hidden="true"></i> Stock
                  </a>
                  <a class="btn btn-success btn-rounded text-white" data-toggle="modal" data-target="#addDataPins">
				  ...
				  <table id="example1" class="table table-sm table-bordered table-striped">
					...
					<?php 
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" onclick="editDataPinDetails('<?php echo $result->dpId; ?>','<?php echo $result->datanetwork; ?>','<?php echo $result->name; ?>','<?php echo $result->type; ?>','<?php echo $result->planid; ?>','<?php echo $result->day; ?>','<?php echo $result->price; ?>','<?php echo $result->userprice; ?>','<?php echo $result->agentprice; ?>','<?php echo $result->vendorprice; ?>','<?php echo $result->loadpin; ?>','<?php echo $result->checkbalance; ?>')" class="btn btn-primary"><i class="fa fa-edit"></i></a> 
						    </td>
                            <td>
                                <a href="#" onclick="deleteDataPin(<?php echo $result->dpId;?>)" class="btn btn-danger"><i class="fa fa-trash"></i></a> 
						    </td>
                        </tr>
                        <?php $cnt=$cnt+1;}} ?>
...
<!-- Add Category Modal -->
<div class="modal fade" data-backdrop="false" id="addDataPins" tabindex="-1">
				  <div class="modal-dialog modal-lg">
					<div class="modal-content border">
					  <div class="modal-header bg-info">
						<h5 class="modal-title">Add New Data Pin</h5>
					</div>
					  ...
					  <form  method="post" class="form-submit">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label for="success" class="control-label">Load Pin</label>
                                <div class="">
                                <input type="text" placeholder="Load Pin" name="loadpin" class="form-control" required="required" >
                                </div>
                            </div>


                            <div class="col-md-6 form-group">
                                <label for="success" class="control-label">Check Balance</label>
                                <div class="">
                                <input type="text" placeholder="Check Balance" name="checkbal" class="form-control" required="required" >
                                </div>
                            </div>
                            </div>
                            ...
                            <button type="submit" name="add-data-pin" class="btn btn-info btn-submit"><i class="fa fa-plus" aria-hidden="true"></i> Add Pin</button>
...
<div class="modal fade" data-backdrop="false" id="editDataPlan" tabindex="-1">
				  <div class="modal-dialog modal-lg">
					<div class="modal-content border">
					  <div class="modal-header bg-info">
						<h5 class="modal-title">Edit Data Pin</h5>
					</div>
					  <div class="modal-body">
					  <form  method="post" class="form-submit">
                      ...
                      <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label for="success" class="control-label">Load Pin</label>
                                <div class="">
                                <input type="text" placeholder="Load Pin" id="loadpin"  name="loadpin" class="form-control" required="required" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                <label for="success" class="control-label">Check Balance</label>
                                <div class="">
                                <input type="text" placeholder="Check Balance" id="checkbal" name="checkbal" class="form-control" required="required" >
                                </div>
                            </div>
                       ...
                       <div class="form-group">
                        <div class="d-flex justify-content-between">
                           <button type="submit" name="update-data-pin" class="btn btn-info btn-submit"><i class="fa fa-save" aria-hidden="true"></i> Update Plan</button>
						   <button type="button" class="btn btn-bold btn-pure btn-secondary" data-dismiss="modal">Close</button>
						</div>
                        </div>
                      </form>
