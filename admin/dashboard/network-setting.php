...
<div class="col-12">
    ...
    <div class="box-header with-border d-flex align-items-center justify-content-between">
        <h4 class="box-title">Netwrok Settings</h4>
        ...
        <?php foreach($data AS $network): if($network->network == $_GET["network"]): ?>
                ...
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> SME2</label>
                    <div class="">
                        <select name="sme2" class="form-control" required="required">
                        <?php if($network->sme2Status == "On"): ?>
                            <option value="On" selected>Enable</option>
                            <option value="Off">Disable</option>
                        <?php else: ?>
                            <option value="On">Enable</option>
               ...
               <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-12">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Coupon Data</label>
                    <div class="">
                        <select name="coupon" class="form-control" required="required">
                        <?php if($network->couponStatus == "On"): ?>
                            <option value="On" selected>Enable</option>
                            <option value="Off">Disable</option>
                        <?php else: ?>
                            <option value="On">Enable</option>
                ...
                <div class="form-group col-md-3">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Momo Airtime</label>
                    <div class="">
                        <select name="momo" class="form-control" required="required">
                        <?php  if($network->momoStatus == "On"): ?>
                            <option value="On" selected>Enable</option>
                            <option value="Off">Disable</option>
                        <?php else: ?>
                            <option value="On">Enable</option>
                ...
                <div class="form-group col-md-3">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Manual Order</label>
                    <div class="">
                        <select name="manualorder" class="form-control" required="required">
                        <?php if($network->manualOrderStatus == "On"): ?>
                            <option value="On" selected>Enable</option>
                            <option value="Off">Disable</option>
                        <?php else: ?>
                            <option value="On">Enable</option>
                ...
                <div class="col-md-12">
                    ...
                    <div class="alert alert-danger">Use This Section To Change The Network ID And Status Of A Service.</div>
                    <hr/>
                </div>
                ...
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> SME2 ID</label>
                    <div class="">
                        <input type="number" name="smeId2" value="<?php echo $network->smeId2; ?>" class="form-control" placeholder="SME2 ID" required />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Coupon ID</label>
                    <div class="">
                        <input type="number" name="couponid" value="<?php echo $network->couponid; ?>" class="form-control" placeholder="Coupon ID" required />
                    </div>
                </div>
