...
<script>
  ...
  function resetUserApi(id){
    swal({   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?reset-user-api-key",{id:id},function(res){
                  ...
                  else{swal("Error!", "Unable To Reset API Key, Please Try Again Later", "error");   }
                });   
              } else {     
   ...
   function terminateUserAccount(id){
    swal({   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?delete-user-account",{id:id},function(res){
                  ...
                  else{swal("Error!", "Unable To Delete Account, Please Try Again Later", "error");   }
                });   
              } else {     
  ...
  //Clear Used Pins
   function clearUsedAirtimePin(){
    swal({   
              title: "Are you sure?",   
              text: "By doing this, all used/sold airtime pins would be cleared from the stock record",   
              type: "warning",   
              showCancelButton: true,   
              confirmButtonColor: "#DD6B55",   
              confirmButtonText: "Yes",   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?clear-used-airtimepin",{id:1},function(res){
                   
                  if(res == 0){
                    swal("Success", "Used Pins Cleared Succesfully", "success");
                    setTimeout(function(){
                      window.location.href="airtime-pin-stock";
                    },1000);   
                  }
                  else{swal("Error!", "Unable To Perfrom Action, Please Try Again Later", "error");   }
                });   
              } else {     
                  swal("Cancelled", "Pins Not Cleared", "error");   
              } 
      });
  }
 
  //Clear Used Pins
  function clearUsedDataPin(){
    swal({   
              title: "Are you sure?",   
              text: "By doing this, all used/sold data pins would be cleared from the stock record",   
              type: "warning",   
              showCancelButton: true,   
              confirmButtonColor: "#DD6B55",   
              confirmButtonText: "Yes",   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?clear-used-datapin",{id:1},function(res){
                   
                  if(res == 0){
                    swal("Success", "Used Pins Cleared Succesfully", "success");
                    setTimeout(function(){
                      window.location.href="data-pin-stock";
                    },1000);   
                  }
                  else{swal("Error!", "Unable To Perfrom Action, Please Try Again Later", "error");   }
                });   
  ...
  //Edit Airtime Discount 
  function editAirtimePinDiscount(networkid,amount,buyprice,user,agent,vendor,loadpin,checkbal,planid){
  ...
  function editAlphaTopup(alphaid,buying,selling,agent,vendor){
   ...
   function deleteAlphaTopup(id){
    swal({   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?delete-alpha-topup",{id:id},function(res){
                  ...
                  else{swal("Error!", "Unable To Delete Alpha Topup, Please Try Again Later", "error");   }
                });   
              } else {     
  ...
  //Edit SMILE Data Plan
  function editSmileDataPlanDetails(id,description,BundleTypeCode,price,validity){
      $("#dataname").val(description);
    $("#planid").val(BundleTypeCode);
    $("#price").val(price);
    $("#duration").val(validity);
    $("#plan").val(id);
    ...
    function deleteSmileDataPlan(id){
    swal({   
              title: "Are you sure?",   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?delete-smile-data-plan",{id:id},function(res){
  ...
  //Edit Data Pin
  function editDataPinDetails(pin,network,dataname,datatype,planid,duration,price,userprice,agentprice,vendorprice,loadpin,checkbal){
    $("#pin").val(pin);
    $("#network").val(network);
    $("#datatype").val(datatype);
    $("#planid").val(planid);
  ...
  function deleteDataPin(id){
    swal({   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?delete-data-pin",{id:id},function(res){
                  ...
                  else{swal("Error!", "Unable To Delete Data Pin, Please Try Again Later", "error");   }
                });   
              } else {     
  ...
  function confirmAlphaTopupOrder(id){
    swal({   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?complete-alpha-order",{id:id},function(res){
                  ...
                  else{swal("Error!", "Unable To Complete Transaction, Please Try Again Later", "error");   }
                });   
              } else {     
  ...
  //Update Airtime To Cash
  function updateAirtimeToCashStatus(id,status){
    if(status == 0){action ="Approve and Credit User Wallet for ";} else if(status == 2){action ="Approve";}  else {action ="Reject";}
    swal({   
              title: "Are you sure?",   
              text: "Are you sure you want to "+action+" this transaction?",   
              type: "warning",   
              showCancelButton: true,   
              confirmButtonColor: "#DD6B55",   
              confirmButtonText: "Yes",   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?update-airtimetocash",{id:id,status:status},function(res){
                   
                  if(res == 0){
                    swal("Success", "Transaction "+action+" Succesfully", "success");
                    setTimeout(function(){
                      $url=window.location.href;
                      window.location.href=$url;
                    },1000);   
                  }
                  else{swal("Error!", "Unable To Update Status, Please Try Again Later", "error");   }
                });   
              } else {     
                  swal("Cancelled", "Status Not Changed", "error");   
              } 
  ...
  function updateManualFundingStatus(id,status,amount,email){
    if(status == 'success'){action ="Approve and Credit User Wallet for ";} else {action ="Reject";}
    ...
    swal({   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?update-manualfund-status",{id:id,status:status,email:email,amount:amount},function(res){
