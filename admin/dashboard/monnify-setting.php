...
<div class="col-12">
    ...
    <div class="box">
        ...
        <form  method="post" class="form-submit">
                ...
                <div class="form-group">
                    <label for="success" class="control-label">GT Bank Activation</label>
                    <div class="">
                        <select name="monifyGtStatus" class="form-control" required="required">
                        <?php if($controller->getConfigValue($data,"monifyGtStatus") == "On"): ?>
                            <option value="On" selected>On</option>
                            <option value="Off">Off</option>
                        <?php else: ?>
                            <option value="On">On</option>
