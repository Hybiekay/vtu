					...
					<div class="modal-content border">
					  ...
					  <form  method="post" class="form-submit">
                        <div class="row">
                            ...
                            <button type="submit" name="add-data-plan" class="btn btn-primary btn-submit"><i class="fa fa-plus" aria-hidden="true"></i> Add Plan</button>
				  ...
				  <div class="modal-dialog modal-lg">
					<div class="modal-content border">
                      ...
                      <div class="row">
                       ...
                       <div class="form-group">
                        <div class="d-flex justify-content-between">
                           <button type="submit" name="update-data-plan" class="btn btn-primary btn-submit"><i class="fa fa-save" aria-hidden="true"></i> Update Plan</button>
						   <button type="button" class="btn btn-bold btn-pure btn-secondary" data-dismiss="modal">Close</button>
						</div>
                        </div>
                      </form>
