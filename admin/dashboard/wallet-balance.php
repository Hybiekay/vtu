	                ...
	                <div class="col-12 col-lg-4">
	                    <div class="box-body br-1 border-light no-radius">
	                        <div class="d-flex align-items-center justify-content-between">
	                            ...
	                            <div>
	                                <h2 class="text-info my-0 text-right">N<?php echo $data[1]["walletFourBalance"]; ?></h2>
	                                <p class="mb-0 text-muted text-right">Wallet Balance</p>
	                                <p class="mb-0 text-dark text-right">(<b><?php echo $data[1]["walletFourProvider"]; ?></b>)</p>
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="col-12 col-lg-4">
	                    <div class="box-body br-1 border-light no-radius">
	                        <div class="d-flex align-items-center justify-content-between">
	                            ...
	                            <div>
	                                <h2 class="text-info my-0 text-right">N<?php echo $data[1]["walletFiveBalance"]; ?> </h2>
	                                <p class="mb-0 text-muted text-right">Wallet Balance</p>
	                                <p class="mb-0 text-dark text-right">(<b><?php echo $data[1]["walletFiveProvider"]; ?></b>)</p>
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="col-12 col-lg-4">
	                    <div class="box-body br-1 border-light no-radius">
	                        <div class="d-flex align-items-center justify-content-between">
	                            ...
	                            <div>
	                                <h2 class="text-info my-0 text-right">N<?php echo $data[1]["walletSixBalance"]; ?> </h2>
	                                <p class="mb-0 text-muted text-right">Wallet Balance</p>
	                                <p class="mb-0 text-dark text-right">(<b><?php echo $data[1]["walletSixProvider"]; ?></b>)</p>
	                            </div>
	                        </div>
	                    </div>
	                </div>
