            ...
            <div class="row no-gutters py-2">
                <div class="col-12 col-lg-4">
                    <div class="box-body br-1 border-light no-radius">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <i class="fa fa-line-chart text-info font-size-50"></i><br>
                            </div>
                            <div>
                                <p class="mb-0 text-muted text-right"><b>Manual Funding</b></p>
                                <h2 class="text-info my-0 text-right">N<?php echo $data["manualFunding"]; ?> </h2>
                                <p class="mb-0 text-dark text-right">(<?php echo $data["manualTransactions"]; ?> Transactions)</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="box-body br-1 border-light no-radius">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <i class="fa fa-bar-chart text-success font-size-50"></i><br>
                            </div>
                            <div>
                                <p class="mb-0 text-muted text-right"><b>Monnify Funding</b></p>
                                <h2 class="text-success my-0 text-right">N<?php echo $data["monnifyFunding"]; ?> </h2>
                                <p class="mb-0 text-dark text-right">(<?php echo $data["monnifyTransactions"]; ?> Transactions)</p>
                ...
                <div class="col-12 col-lg-4">
                    <div class="box-body br-1 border-light no-radius">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <i class="fa fa-area-chart text-primary font-size-50"></i><br>
                            </div>
                            <div>
                                <p class="mb-0 text-muted text-right"><b>Kuda Funding</b></p>
                                <h2 class="text-primary my-0 text-right">N<?php echo $data["kudaFunding"]; ?> </h2>
                                <p class="mb-0 text-dark text-right">(<?php echo $data["kudaTransactions"]; ?> Transactions)</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <i class="fa fa-mobile text-primary font-size-50"></i><br><br/>
                                    <h4 class="text-dark"><b>Airtime To Cash <br/> Sales</b></h4> 
                                    <h2 class="text-primary">N<?php echo $data["airtime2cashSales"]; ?></h2>
                                    <h4 class="text-dark"><b>(<?php echo $data["airtime2cashTransactions"]; ?> Transactions)</b></h4> 
                                </td>

                                <td>
                                    <i class="fa fa-mobile text-success font-size-50"></i><br><br>
                                    <h4 class="text-dark"><b>Airtime To Cash <br/> Profit</b></h4> 
                                    <h2 class="text-success">N<?php echo $data["airtime2cashProfit"]; ?></h2>
                                    <h4 class="text-dark"><b>(<?php echo $data["airtime2cashTransactions"]; ?> Transactions)</b></h4> 
                                </td>
