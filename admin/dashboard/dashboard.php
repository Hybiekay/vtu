						...
						<div class="box">
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="">
										<h2 class="mb-2"> 
										<?php echo $data[0]["alphaCount"]; ?> <small>Alpha</small>
										<?php echo $data[0]["smileCount"]; ?> <small>Smile</small></h2>
										<p class="text-muted mb-0"><span class="badge badge-danger">All Request</span></p>
									</div>
									<div class="fa fa-list-alt text-danger font-size-30"></div>
								</div>
							</div>
