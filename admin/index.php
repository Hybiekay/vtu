...
<head>
    ...
    <style>
        body{background:linear-gradient(#000099,#3333ff); 
            background-image:url("../assets/img/bg.jpg?v=1");   
            ...
            .brand_logo{height:150px;width:155px;border-radius:50%;text-align:center;}
...
<div id="loginContainerContent">
            ...
            <div>
                <div align="center" class="brand_logo_container"><img src="../assets/img/adminicon.png" alt="Logo" class="brand_logo" /></div>
